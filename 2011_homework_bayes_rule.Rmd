...
We are now **searching** for the probability that an eyewitness **actually* observed a wildfire that was caused by a lightning.
...
* fire was caused by a lightning and so the witness is true
* fire was not caused by a lightning and the witness is incorrect

**Here, we can use the law of probability**:
...
"Thus, even if the witness states the wildfire was caused by lightning, the probability of being true is ``r post``"
