...
```{r}
#<center>
#side by side ![](doggy.jpeg) ![](kitty.jpeg)

#![Figure 5:  Su Village (Sucun) landslide in Zhejiang Province, China (Ouyang et al., 2019).](ADD NAME)

##landslides: https://blogs.agu.org/landslideblog/

#![Figure 6:  Pareto probability distribution function, with fixed scale parameter and varying shape parameters (boost.org).](ADD NAME)
...
#knitr::include_graphics("https://www.capitalfm.co.ke/news/files/2019/02/LANDSLIDE.jpg")

#knitr::include_graphics("https://actuarialmodelingtopics.files.wordpress.com/2017/05/pareto-pdfs.jpg")
...
#Option 2: https://github.com/yihui/xaringan/issues/30
...
##add caption!!
##https://www.usaid.gov/what-we-do/working-crises-and-conflict/disaster-risk-reduction/usaidofda-disaster-risk-reduction
...
par(mfrow = c(3,1))
plot(prior_EQ,prior_prob_EQ, type = "h", xlab = "Major damage probability", ylab = "Prior probability", lwd = 2, col="skyblue3")
grid()

plot(prior_rock,prior_prob_rock, type = "h", xlab = "Major damage probability", ylab = "Prior probability", lwd = 2, col="seagreen3")
grid()

plot(prior_flood,prior_prob_flood, type = "h", xlab = "Major damage probability", ylab = "Prior probability", lwd = 2, col="darkorange3")
grid()
```
<br><br>
...
par(mfrow = c(3,1))
plot(prior_EQ, likeli_EQ, type="h",xlab = "Major damage probability", ylab = "Likelihood", lwd = 2, col="skyblue3")
grid()
plot(prior_rock, likeli_rock, type="h", xlab = "Major damage probability", ylab = "Likelihood", lwd = 2, col="seagreen3")
grid()
plot(prior_flood, likeli_flood, type="h", xlab = "Major damage probability", ylab = "Likelihood", lwd = 2, col="darkorange3")
grid()
...
par(mfrow = c(3,1))
plot(prior_EQ, posterior_EQ, type="h", xlab = "Major damage probability", ylab = "Posterior probability", lwd = 2, col="skyblue3")
legend(0.85, 0.05, legend = c("most probable p"),
      col = c("firebrick3"), lty = 2, lwd = 1, cex = 0.8)
abline(v = max_EQ, lty = 2, lwd = 2, col = "firebrick3")
grid()
plot(prior_rock, posterior_rock, type="h", xlab = "Major damage probability", ylab = "Posterior probability", lwd = 2, col="seagreen3")
abline(v = max_rock, lty = 2, lwd = 2, col = "firebrick3")
grid()
plot(prior_flood, posterior_flood, type="h", xlab = "Major damage probability", ylab = "Posterior probability", lwd = 2, col="darkorange3")
